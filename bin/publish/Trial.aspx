<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Trial.aspx.vb" Inherits="AG_SCAN.Trial" %>
                    ...
                    <table class="auto-style2">
                        ...
                        <tr>
                            <td class="auto-style31">
                                <asp:Label ID="Label5" runat="server" Text="Trial" Font-Bold="True"></asp:Label>
                            </td>
                            <td class="auto-style32">
                                <asp:DropDownList ID="ddlRange" runat="server" CssClass="txtTahun">
                        ...
                        <tr>
                            ...
                            <td class="auto-style20">
                                <asp:TextBox ID="txtLama" runat="server" CssClass="txtIsian" MaxLength="200"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="auto-style6">
                                <asp:ImageButton ID="imgButtonSimpan" runat="server" ImageUrl="~/images/scan_next.png" />
                            </td>
                            <td class="auto-style6">
                                &nbsp;</td>
                        </tr>
