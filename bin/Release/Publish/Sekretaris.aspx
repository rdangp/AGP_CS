<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sekretaris.aspx.vb" Inherits="AG_SCAN.Sekretaris" %>
                    ...
                    <table class="auto-style2">
                        ...
                        <tr>
                            <td class="auto-style14">
                                <asp:Label ID="Label7" runat="server" Text="Jenis Dokumen" Font-Bold="True"></asp:Label>
                            </td>
                            <td class="auto-style20">
                                <asp:DropDownList ID="ddlJenis" runat="server" CssClass="txtTahun">
                                    <asp:ListItem>Pilih Jenis Dokumen</asp:ListItem>
                                    <asp:ListItem>BK Online</asp:ListItem>
                                    <asp:ListItem>PR</asp:ListItem>
                                    <asp:ListItem>Pembebanan</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            <td class="auto-style25">
                                <asp:Label ID="Label1" runat="server" Text="Tanggal" Font-Bold="True"></asp:Label>
                            </td>
                            <td class="auto-style26">
                                <asp:TextBox ID="txtTanggal" runat="server" CssClass="txtTanggal"></asp:TextBox>
                        ...
                        <tr>
                            <td class="auto-style10">
                                <asp:Label ID="Label2" runat="server" Text="Nama File" Font-Bold="True"></asp:Label>
                            </td>
                            <td class="auto-style27">
                                <asp:TextBox ID="txtNamaFile" runat="server" CssClass="txtIsian" MaxLength="200"></asp:TextBox>
                            </td>
                            <td class="auto-style27">
