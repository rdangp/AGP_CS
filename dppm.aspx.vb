...
Public Class dppm
    ...
    Dim FolderPaths As String = My.Settings.DirScanDPPM
    Dim RootDirectoryPath As String = My.Settings.DirScanDPPM
    ...
    Private Const ReturnPath As String = "dppm.aspx"
    ...
    Private Sub ProcessScan()
        ...
        Dim tgl As String
        If txtTgl.Text.Length = 1 Then
            tgl = "0" & txtTgl.Text
        Else
            tgl = txtTgl.Text
        End If

        Dim tglblnthn As String = tgl & Left(ddlBulan.SelectedValue.ToString, 2) & Right(ddlTahun.SelectedValue.ToString, 2)

        Title_scan = txtDPPM.Text & "_" & txtPelanggan.Text & "_" & txtEQ.Text & "_" & tglblnthn
