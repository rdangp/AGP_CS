...
Public Class kontrak
    ...
    Dim FolderPaths As String = My.Settings.DirScanKontrak
    Dim RootDirectoryPath As String = My.Settings.DirScanKontrak
    ...
    Private Const ReturnPath As String = "kontrak.aspx"
    ...
    Private Sub ProcessScan()
        ...
        'sharepoint & google
        'FolderPaths = "Document Scan\Kontrak" & "\" & ddlTahun.SelectedItem.ToString & "\" & ddlBulan.SelectedValue.ToString
        FolderPaths = FolderPaths & "\" & ddlTahun.SelectedItem.ToString & "\" & ddlBulan.SelectedValue.ToString
        Title_scan = txtPelanggan.Text & "_" & txtEQ.Text & ".pdf"

        'FolderPaths = FolderPaths & "\" & ddlCabang.SelectedItem.ToString & "\" & ddlTahun.SelectedItem.ToString & "\" & ddlBulan.SelectedValue.ToString
        'FolderPaths = FolderPaths & "\" & ddlTahun.SelectedItem.ToString & "\" & ddlBulan.SelectedValue.ToString
        'Title_scan = txtPelanggan.Text & "_" & txtEQ.Text
        ...
        Session("NAMA") = txtPelanggan.Text
        Session("EQ") = txtEQ.Text
        Session("Bulan") = ddlBulan.SelectedValue.ToString
        Session("Tahun") = ddlTahun.SelectedValue.ToString
